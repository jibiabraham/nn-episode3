 ...
 */
public class FriendsPostsAdapter extends BaseAdapter {
    Context context;
    ArrayList<PostItem> posts;

    public FriendsPostsAdapter(Context context, ArrayList<PostItem> posts){
    ...
    public View getView(int position, View convertView, ViewGroup parent) {
        ...
        if(convertView == null){
            ...
            convertView = mInflater.inflate(R.layout.post_item_friends, null);
        }
